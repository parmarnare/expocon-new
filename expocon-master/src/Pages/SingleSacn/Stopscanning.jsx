    ...
    <div>
      ...
      <div className="flex justify-center items-center my-5">
        <div className="bg-white  bg-opacity-20 md:w-1/2 w-full  px-5  shado rounded-xl p-5 text-center flex justify-center items-center flex-col">
          ...
          <button
            type="submit"
            className="text-white flex gap-10 my-5 items-center bg-transparent bg-primary  hover:bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 h-full font-medium rounded-xl text-sm px-10 py-2 "
          >
            <div>Back Camera</div>
            <div>
              <IoIosArrowUp />
