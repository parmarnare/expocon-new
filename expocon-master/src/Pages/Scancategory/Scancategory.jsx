...
const Scancategory = () => {
  ...
  const editScan = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.put(`https://expocon-master.vercel.app/api/v1//scan/update`, {
        _id: editScanId,
  ...
  const createScanCategory = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`https://expocon-master.vercel.app/api/v1//scan/create`, {
        category: scanName,
        type: scanType,
      });
      if (res?.data?.success) {
  ...
  const getAllScans = async () => {
    try {
      const res = await axios.get(
        `https://expocon-master.vercel.app/api/v1//scan/all-scans`
      );
